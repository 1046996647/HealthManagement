...
+ (void)showScaleAnimationInView:(UIView *)view Repeat:(CGFloat)repeat Autoreverses:(BOOL)autoreverses FromValue:(float)fromValue ToValue:(float)toValue Duration:(CGFloat)duration {
...
+ (void)showMoveAnimationInView:(UIView *)view Position:(CGPoint)position Repeat:(CGFloat)repeat Autoreverses:(BOOL)autoreverses Duration:(CGFloat)duration {
...
+ (void)showRotateAnimationInView:(UIView *)view  Degree:(CGFloat)degree Direction:(Axis)direction Repeat:(CGFloat)repeat Autoreverses:(BOOL)autoreverses Duration:(CGFloat)duration {
    if (repeat == 0) {
        repeat = MAXFLOAT;
    }
...
+ (void)showOpacityAnimationInView:(UIView *)view Alpha:(CGFloat)alpha Repeat:(CGFloat)repeat Autoreverses:(BOOL)autoreverses Duration:(CGFloat)duration {
    if (repeat == 0) {
        repeat = MAXFLOAT;
    }
