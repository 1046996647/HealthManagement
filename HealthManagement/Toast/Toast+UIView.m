...
static const CGFloat CSToastHorizontalPadding   = 24.0;
static const CGFloat CSToastVerticalPadding     = 18.0;
static const CGFloat CSToastCornerRadius        = 5;
...
//    MDLog(@"Warning: Invalid position for toast.");
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    wrapperView.backgroundColor = [[UIColor colorWithRed:51/255.0 green:51/255.0  blue:51/255.0  alpha:1.0] colorWithAlphaComponent:CSToastOpacity];
