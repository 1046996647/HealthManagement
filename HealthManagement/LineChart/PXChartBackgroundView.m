    ...
    for (int i = 0; i < lines; i++) {
        ...
        for (int j = 0; j < points.count; j++) {
            ...
            if (!isPointHide) {
                ...
                // 修改的
                pointButton.layer.borderColor = [UIColor greenColor].CGColor;
            ...
            CGSize buttonSize = [[NSString stringWithFormat:@"%@步",pointYvalue] sizeWithAttributes:attr];
            UIButton *titlebutton = [[UIButton alloc] init];
            
            [titlebutton setTitle:[NSString stringWithFormat:@"%@步",pointYvalue] forState:UIControlStateNormal];
