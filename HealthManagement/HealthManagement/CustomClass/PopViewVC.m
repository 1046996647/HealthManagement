...
//    _titleArr = @[@"相册",@"拍照"];
    ...
    //创建tableView
    _tableView=[[UITableView alloc]initWithFrame:CGRectMake(0, kScreen_Height, kScreen_Width, 180 + 5) style:UITableViewStylePlain];
...
- (void)delayAction
{
    [UIView animateWithDuration:.5 animations:^{
        _tableView.top = kScreen_Height-(180 + 5);
    }];
}
