...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [wechatBtn setImage:[UIImage imageNamed:@"proNoChoose"] forState:UIControlStateNormal];
        [wechatBtn setImage:[UIImage imageNamed:@"proChoose"] forState:UIControlStateSelected];
