...
//    countLab.text = @"本月销售3434份";
    countLab.text = [NSString stringWithFormat:@"本月销售%@份",self.model.sales];
...
- (void)initCollectionView
{
    ...
    _lab3.text = @"中餐 1.1km";
//    _lab3.text = [NSString stringWithFormat:@"%@ %@",self.model.category,[NSString meterToKilometer:self.model.distance]];
...
//    _lab5.text = @"拱墅区祥园路28号";
    _lab5.text = self.model.Restaurant_Address;
