...
//    self.lab2 = lab2;
    ...
    // 背景图片
    UIImageView *baseView = [UIImageView imgViewWithframe:CGRectMake(0, view1.bottom, kScreen_Width, 0) icon:@"bg_run"];
    ...
    [sportBtn setImage:[UIImage imageNamed:@"run_circle"] forState:UIControlStateNormal];
...
//    sportBtn.backgroundColor = [UIColor redColor];
...
//    sportView.backgroundColor = [UIColor redColor];
    ...
    UIImageView *stateImg = [UIImageView imgViewWithframe:CGRectMake(0, 0, sportView.width, sportView.width) icon:@"run_timeout"];
    [sportView addSubview:stateImg];
    stateImg.contentMode = UIViewContentModeScaleAspectFit;
    ...
    sportImg.image = [UIImage imageNamed:@"runman"];
...
//    _sportLab.text = @"尚未运动";
    ...
    _startLab = [[UILabel alloc] initWithFrame:CGRectMake((sportView.width-sportBtn.width)/2.0, sportImg.bottom+10, sportBtn.width, 32)];
...
//    _startLab.userInteractionEnabled = YES;
    ...
    _startLab.textColor = [UIColor colorWithHexString:@"#5FCC73"];
    [sportView addSubview:_startLab];
    
    _stepLab = [[UILabel alloc] initWithFrame:CGRectMake(0, _startLab.bottom+10, sportView.width, 15)];
    _stepLab.font = [UIFont boldSystemFontOfSize:14];
    _stepLab.text = @"步数";
    _stepLab.textAlignment = NSTextAlignmentCenter;
    _stepLab.textColor = [UIColor colorWithHexString:@"#7A7B7C"];
    ...
    [timeBtn setImage:[UIImage imageNamed:@"time_circle"] forState:UIControlStateNormal];
    ...
    timeImg.image = [UIImage imageNamed:@"finish_time"];
    //        _imgView.contentMode = UIViewContentModeScaleAspectFit;
...
//    _timeLab1.text = @"103 min";
    ...
    _timeLab1.textColor = [UIColor whiteColor];
    ...
    _timeLab2.textColor = [UIColor whiteColor];
    ...
    [disBtn setImage:[UIImage imageNamed:@"speed_circle"] forState:UIControlStateNormal];
    //    [shopBtn addTarget:self action:@selector(btnAction) forControlEvents:UIControlEventTouchUpInside];
    [baseView addSubview:disBtn];
    self.disBtn = disBtn;
    ...
    disImg.image = [UIImage imageNamed:@"speed_meter"];
    //        _imgView.contentMode = UIViewContentModeScaleAspectFit;
...
//    _disLab1.text = @"23 km";
    ...
    _disLab1.textColor = [UIColor whiteColor];
    ...
    _disLab2.textColor = [UIColor whiteColor];
    [disView addSubview:_disLab2];
    
    baseView.height = timeBtn.bottom+30-6;
    [baseView bringSubviewToFront:sportBtn];
...
//        return;
        ...
        if (state.integerValue == 2) {
            _sportLab.text = @"今日运动";
            NSString *str1 = @"GO >";
            NSMutableAttributedString *attStr = [NSString text:str1 fullText:[NSString stringWithFormat:@"步数  %@",str1] location:4 color:[UIColor colorWithHexString:@"#C3C4C5"] font:[UIFont boldSystemFontOfSize:16]];
            _stepLab.attributedText = attStr;
...
//        _startLab.textColor = [UIColor colorWithHexString:@"#58B6DA"];
    ...
    NSMutableAttributedString *attr = [NSString text:self.time fullText:[NSString stringWithFormat:@"%@ min",self.time] location:0 color:[UIColor colorWithHexString:@"#FD814A"] font:[UIFont boldSystemFontOfSize:28]];
    _timeLab1.attributedText = attr;
    
    attr = [NSString text:self.distance fullText:[NSString stringWithFormat:@"%@ km",self.distance] location:0 color:[UIColor colorWithHexString:@"#F75963"] font:[UIFont boldSystemFontOfSize:25]];
