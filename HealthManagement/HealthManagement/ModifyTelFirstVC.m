...
#define kCountDownForVerifyCode @"CountDownForVerifyCodeFirst"



@interface ModifyTelFirstVC ()
...
@implementation ModifyTelFirstVC
...
- (void)registerAction
{
    ...
    [AFNetworking_RequestData requestMethodPOSTUrl:VerificationCode dic:paramDic Succed:^(id responseObject) {
