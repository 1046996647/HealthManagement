...
@objc public  protocol TenClockDelegate {
    ...
    @objc optional func timesTotal(_ clock:TenClock, time:Int ) -> ()
...
open class TenClock : UIControl{
    ...
    open var headText: String = "sleep_1"
    open var tailText: String = "sleep_4"
...
//        gradientLayer.colors = [UIColor(red: 178/255, green: 221/255, blue: 107/255, alpha: 1).cgColor, UIColor(red: 251/255, green: 130/255, blue: 5/255, alpha: 1).cgColor]
        gradientLayer.colors = [UIColor(red: 180/255, green: 220/255, blue: 107/255, alpha:1).cgColor, UIColor(red: 255/255, green: 126/255, blue: 0/255, alpha:1).cgColor]
...
//        print("start = \(headAngle / CGFloat(M_PI)), end = \(tailAngle / CGFloat(M_PI))")
    ...
    func tlabel(_ str:String, color:UIColor? = nil) -> CATextLayer {
        ...
        let l = CATextLayer()
        l.bounds.size = CGSize(width: pathWidth, height: pathWidth)
...
//        imageView.layer.bounds.size = CGSize(width: 30, height: 15)
//        imageView.layer.alignmentMode = kCAAlignmentCenter
//        imageView.layer.contentsScale = UIScreen.main.scale
        l.addSublayer(imageView.layer);
        return l
    }
